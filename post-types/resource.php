	...
	*/
	...
	static function initialize() {
		...
		*/
		...
		/**
		 * a template for handing the grid card of the \Mandy\Grid_Service
		 * @param string $card a pre-rendered card. In this case, it's based on the get_post_card function of \Mandy\Grid_Service
