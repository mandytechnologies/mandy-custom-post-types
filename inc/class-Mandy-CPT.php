...
abstract class Custom_Post_Type {
	 ...
	 * admin_columns while hooking into `mandy_cpt_admin_columns`
	 *
	 * @return array
	 */
	static function get_admin_columns() {
		return \apply_filters('mandy_cpt_admin_columns', static::$admin_columns, static::$name);
	}
	...
	static function initialize() {
		...
		// add our taxonomies
		$taxonomies = \apply_filters('mandy_cpt_register_taxonomies', static::$taxonomies, static::$name);
